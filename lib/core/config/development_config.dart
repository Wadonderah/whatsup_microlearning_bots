...
class DevelopmentConfig {
  ...
  static const bool enableGoogleSignIn =
      false; // Set to false for Windows testing
  static const bool enableLocalAuth =
      true; // Enable local authentication simulation
  ...
  static void showDevWarning() {
    if (isDevelopmentMode) {
      ...
      devLog(
          '🔧 To enable Firebase: Set enableFirebase = true in development_config.dart');
    }
  }
}
